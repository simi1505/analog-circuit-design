...
Please note that Middlebrook's method works well for $|T| \gg 1$, so it will show inaccuracies at the crossover frequency of the open-loop gain at $|T(s)| \approx 1$. An improved method (slightly more complicated) can be found in [@Tian_2001].
